...
_WARNING: the choice of the number of cores for paralleled calculations_
...
## 3. Relationship between population size and areas of all cities

### 3.1 Overview of relationships
Function for linear regression and summarized data:
```{r}
...
Intersecting new polygons and spatial polygons of cities:
```{r, warning=FALSE}
